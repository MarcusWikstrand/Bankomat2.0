...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="makeblock">
        ...
        <asp:Button ID="Button2" runat="server" Text="2" Width="30px" TabIndex="2" Visible="False" />
        <asp:Button ID="Button3" runat="server" Text="3" Width="30px" Visible="False" />
        <br />
        <asp:Button ID="Button4" runat="server" Text="4" Width="30px" Visible="False" />
        <asp:Button ID="Button5" runat="server" Text="5" Width="30px" Visible="False" />
        <asp:Button ID="Button6" runat="server" Text="6" Width="30px" Visible="False" />
        <br />
        <asp:Button ID="Button7" runat="server" Text="7" Width="30px" Visible="False" />
        <asp:Button ID="Button8" runat="server" Text="8" Width="30px" Visible="False" />
        <asp:Button ID="Button9" runat="server" Text="9" Width="30px" Visible="False" />
        <br />
