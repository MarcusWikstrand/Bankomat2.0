...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="centrera">
        <asp:Button ID="Reduce100" runat="server" CssClass="sedelpadd roundbuttminus" OnClick="Reduce100_Click" Text="-" />
        <asp:Image ID="img100" runat="server" class="sedelpadd" ImageUrl="~/images/100 kronor ny sedel 1.jpg" Width="200px" />
        <asp:Button ID="Add100" runat="server" class="sedelpadd roundbuttplus" OnClick="Add100_Click" Text="+" /><br />
